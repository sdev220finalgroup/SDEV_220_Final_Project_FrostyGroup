...
# Define Style of icecream flavors and topping prices
Type_prices = {"Small Cone": 2.75, "Medium Cone": 3.25, "Large Cone": 3.75, "Small Cup": 2.65, "Medium Cup": 3.15, "Large Cup": 3.65, "Small Shake": 4.50, "Medium Shake": 5.00, "Large Shake": 8.00}
topping_prices = {"m&m": 1.99, "Nerds": 0.99, "Reese's": 2.99, "Oreo": 1.49, "Cherry": 3.99}
iceCream = {"Strawberry", "Vanilla", "Chocolate", "Banana"}
# Define global variable for total price label
total_price_label = None

def add_to_cart(item):
    # Get the price of the item
    if item in Type_prices:
        price = Type_prices[item]
    elif item in topping_prices:
        price = topping_prices[item]
    elif item in iceCream:
      price = 0.00
    else:
        price = 0
...
#Create print sales button 
print_sales_button = tk.Button(root, text="Print Sales", bg="red", fg="white", font=("Arial",14), command=print_sale)